...
type: Reference
title: Node Paths
description: $ shorthand, get_node(), groups, and path conventions for referencing nodes in Godot 4.x
tags:
  - node-paths
  - get-node
  - groups
...
- [patterns/scripts.md](../patterns/scripts.md) - GDScript patterns using $ and @onready
- [patterns/ui.md](../patterns/ui.md) - UI patterns using node path references
