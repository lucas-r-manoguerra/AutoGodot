...
description: @export, @onready, type hints, range, enum exports, and Inspector integration in Godot 4.x
tags:
  - export
  - onready
  - inspector
...
- [patterns/scripts.md](../patterns/scripts.md) - GDScript patterns using @export and @onready
- [patterns/ui.md](../patterns/ui.md) - UI patterns using @onready for label references
