...
description: Collision layers, masks, body types, Area2D signals, and common collision patterns in Godot 4.x
tags:
  - physics
  - collision
  - layers
...
- [migration/godot-4.md](../migration/godot-4.md) - Collision layer API changes from 3.x to 4.x
