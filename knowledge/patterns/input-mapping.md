...
type: Reference
title: Input Mapping
description: Input Actions setup, reading input, multiple keys, and gamepad support in Godot 4.7
tags:
  - input
  - input-actions
  - gamepad
...
- [patterns/scripts.md](scripts.md) - GDScript movement patterns that consume input actions
