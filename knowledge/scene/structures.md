---
type: Reference
title: Scene File Structures
description: How Godot .tscn files are structured, ext_resource patterns, and complete scene examples
tags:
  - scene
  - tscn
  - ext-resource
...
- [patterns/resource-loading.md](../patterns/resource-loading.md) - preload/load and PackedScene patterns
